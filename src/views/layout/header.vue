	...
	<nav class="sidebar">
        ...
        <div class="sidebar-body">
            <ul class="nav">
				...
				<router-link tag="li" to="/table" class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="link-icon" data-feather="menu"></i>
                        <span class="link-title">Table</span>
                    </a>
                </router-link>
				<router-link tag="li" to="/btable" class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="link-icon" data-feather="menu"></i>
                        <span class="link-title">Table With Bootsrap</span>
                    </a>
                </router-link>
				<router-link tag="li" to="/forminput" class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="link-icon" data-feather="menu"></i>
                        <span class="link-title">Input With Bootsrap</span>
                    </a>
                </router-link>
				<router-link tag="li" to="/useradmin" class="nav-item">
                    <a href="#" class="nav-link">
                        <i class="link-icon" data-feather="user"></i>
                        <span class="link-title">Useradmin</span>
                    </a>
                </router-link>
            </ul>
        </div>
